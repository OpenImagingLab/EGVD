...
CHECKPOINT_DIR=/mnt/workspace/zhangziran/DiffEVS/svd_keyframe_interpolation-main/ckpt/checkpoints_wnorm_wfilter_v5/svd_reverse_motion_with_attnflip/checkpoint-45000
MODEL_NAME=/mnt/workspace/zhangziran/DiffEVS/svd_keyframe_interpolation-main/checkpoints/stable-video-diffusion-img2vid


OUT_DIR=my_results2/r20250305_debug5_abfuse_30000_skip3_v5nw
out_fn=$OUT_DIR/'example.gif'
python z0305_evs_keyframe_interpolation_color_nw.py \
...
OUT_DIR=my_results2/r20250305_debug5_abfuse_30000_skip2_v5nw
out_fn=$OUT_DIR/'example.gif'
python z0305_evs_keyframe_interpolation_color_nw.py \
    --frames_dirs="/mnt/workspace/zhangziran/Self_collected_DATASET/train_sd_vfi/test" \
    --pretrained_model_name_or_path=$MODEL_NAME \
...
OUT_DIR=my_results2/r20250305_debug5_abfuse_30000_skip1_v5nw
out_fn=$OUT_DIR/'example.gif'
python z0305_evs_keyframe_interpolation_color_nw.py \
    --frames_dirs="/mnt/workspace/zhangziran/Self_collected_DATASET/train_sd_vfi/test" \
    --pretrained_model_name_or_path=$MODEL_NAME \
