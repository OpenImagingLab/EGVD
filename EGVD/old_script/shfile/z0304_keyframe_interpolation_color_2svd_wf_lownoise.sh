...
OUT_DIR=my_results2/r20250222_2SVD_skip3r
out_fn=$OUT_DIR/'example.gif'
python z0304_evs_keyframe_interpolation_color_2svd_6eval.py \
...
OUT_DIR=my_results2/r20250222_2SVD_skip2r
out_fn=$OUT_DIR/'example.gif'
python z0304_evs_keyframe_interpolation_color_2svd_6eval.py \
    --frames_dirs="/mnt/workspace/zhangziran/Self_collected_DATASET/train_sd_vfi/test" \
    --pretrained_model_name_or_path=$MODEL_NAME \
...
OUT_DIR=my_results2/r20250222_2SVD_skip1r
out_fn=$OUT_DIR/'example.gif'
python z0304_evs_keyframe_interpolation_color_2svd_6eval.py \
    --frames_dirs="/mnt/workspace/zhangziran/Self_collected_DATASET/train_sd_vfi/test" \
    --pretrained_model_name_or_path=$MODEL_NAME \
