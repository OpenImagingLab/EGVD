...
def main():
    ...
    pre_path = "/mnt/workspace/zhangziran/DiffEVS/svd_keyframe_interpolation-main/ckpt/checkpoints_z0218_newfusemodel_wf/svd_reverse_motion_with_attnflip/checkpoint-30000/lef_model_checkpoint.pt"
