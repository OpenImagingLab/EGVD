...
accelerate launch --mixed_precision="fp16" evs_train_single_svd3_color.py \
  ...
  --output_dir="ckpt/checkpoints_wnorm_wfilter_v8_color3_mixskip2/svd_reverse_motion_with_attnflip" \
  --cache_dir="ckpt/checkpoints_wnorm_wfilter_v8_color3_mixskip2/svd_reverse_motion_with_attnflip_cache" \
