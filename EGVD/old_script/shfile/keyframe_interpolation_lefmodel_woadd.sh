...
OUT_DIR=my_results/r20250215_debug5_lefmodel_wf_woadd_120000_skip3
out_fn=$OUT_DIR/'example.gif'
python evs_keyframe_interpolation_color_fuse_lefmodel_woadd.py \
...
OUT_DIR=my_results/r20250215_debug5_lefmodel_wf_woadd_120000_skip2
out_fn=$OUT_DIR/'example.gif'
python evs_keyframe_interpolation_color_fuse_lefmodel_woadd.py \
    --frames_dirs="/mnt/workspace/zhangziran/Self_collected_DATASET/train_sd_vfi/test" \
    --pretrained_model_name_or_path=$MODEL_NAME \
...
OUT_DIR=my_results/r20250215_debug5_lefmodel_wf_woadd_120000_skip1
out_fn=$OUT_DIR/'example.gif'
python evs_keyframe_interpolation_color_fuse_lefmodel_woadd.py \
    --frames_dirs="/mnt/workspace/zhangziran/Self_collected_DATASET/train_sd_vfi/test" \
    --pretrained_model_name_or_path=$MODEL_NAME \
