...
CHECKPOINT_DIR=/mnt/workspace/zhangziran/DiffEVS/svd_keyframe_interpolation-main/ckpt/checkpoints_wnorm_wfilter_v8_color3_mixskip2/svd_reverse_motion_with_attnflip/checkpoint-10000
MODEL_NAME=/mnt/workspace/zhangziran/DiffEVS/svd_keyframe_interpolation-main/checkpoints/stable-video-diffusion-img2vid
OUT_DIR=my_results/r20250212_checkpoints_wnorm_wfilter_v8_color3_mixskip2_skip3
...
OUT_DIR=my_results/r20250212_checkpoints_wnorm_wfilter_v8_color3_mixskip2_skip2
out_fn=$OUT_DIR/'example.gif'
python evs_keyframe_interpolation_color.py \
    --frames_dirs="/mnt/workspace/zhangziran/Self_collected_DATASET/train_sd_vfi/test" \
    --pretrained_model_name_or_path=$MODEL_NAME \
...
OUT_DIR=my_results/r20250212_checkpoints_wnorm_wfilter_v8_color3_mixskip2_skip1
out_fn=$OUT_DIR/'example.gif'
python evs_keyframe_interpolation_color.py \
    --frames_dirs="/mnt/workspace/zhangziran/Self_collected_DATASET/train_sd_vfi/test" \
    --pretrained_model_name_or_path=$MODEL_NAME \
