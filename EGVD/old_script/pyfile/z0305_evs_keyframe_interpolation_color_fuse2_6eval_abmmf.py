...
from custom_diffusers.pipelines.evs_pipeline_frame_interpolation_with_noise_injection_color_fuse2_ab_mmf import EVSFrameInterpolationWithNoiseInjectionPipeline
...
def main(args):
    ...
    lef_path = "/mnt/workspace/zhangziran/DiffEVS/svd_keyframe_interpolation-main/ckpt/checkpoints_z0226_abmmf/svd_reverse_motion_with_attnflip/lef_model_checkpoint-30000.pt"
