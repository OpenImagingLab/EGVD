...
CHECKPOINT_DIR=/mnt/workspace/zhangziran/DiffEVS/svd_keyframe_interpolation-main/ckpt/checkpoints_wnorm_wofilter_v5/svd_reverse_motion_with_attnflip/checkpoint-5000
...
OUT_DIR=my_results/r20250129_large_resolution_evs_wnorm_wofilter_v5_1000_crop
...
python old0208_evs_keyframe_interpolation.py \
