...
def main():
    ...
    pre_path = "/mnt/workspace/zhangziran/DiffEVS/svd_keyframe_interpolation-main/ckpt/checkpoints_z0213_wfilter_v8_colorfuse_dlc_wf_newfusemodel_rerun/svd_reverse_motion_with_attnflip/checkpoint-80000/lef_model_checkpoint.pt"
