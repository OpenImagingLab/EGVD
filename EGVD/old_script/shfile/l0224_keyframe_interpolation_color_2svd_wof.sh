...
OUT_DIR=my_results/r20250222_2SVD_skip3r
out_fn=$OUT_DIR/'example.gif'
python keyframe_interpolation_2svd.py \
...
OUT_DIR=my_results/r20250222_2SVD_skip2r
out_fn=$OUT_DIR/'example.gif'
python keyframe_interpolation_2svd.py \
    --frames_dirs="/mnt/workspace/zhangziran/Self_collected_DATASET/train_sd_vfi/test" \
    --pretrained_model_name_or_path=$MODEL_NAME \
...
OUT_DIR=my_results/r20250222_2SVD_skip1r
out_fn=$OUT_DIR/'example.gif'
python keyframe_interpolation_2svd.py \
    --frames_dirs="/mnt/workspace/zhangziran/Self_collected_DATASET/train_sd_vfi/test" \
    --pretrained_model_name_or_path=$MODEL_NAME \
