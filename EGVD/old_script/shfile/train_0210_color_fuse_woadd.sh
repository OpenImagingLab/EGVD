...
accelerate launch --mixed_precision="fp16" evs_train_single_svd3_color_fuse_woadd.py \
  ...
  --output_dir="ckpt/checkpoints_z0214_wfilter_v8_colorfuse_wof_newfusemodel_woadd/svd_reverse_motion_with_attnflip" \
  --cache_dir="ckpt/checkpoints_z0214_wfilter_v8_colorfuse_wof_newfusemodel_woadd/svd_reverse_motion_with_attnflip_cache" \
