...
accelerate launch --mixed_precision="fp16" evs_train_single_svd3_color_fuse.py \
  ...
  --output_dir="ckpt/checkpoints_z0213_wfilter_v8_colorfuse_wf_newfusemodel/svd_reverse_motion_with_attnflip" \
  --cache_dir="ckpt/checkpoints_z0213_wfilter_v8_colorfuse_wf_newfusemodel/svd_reverse_motion_with_attnflip_cache" \
