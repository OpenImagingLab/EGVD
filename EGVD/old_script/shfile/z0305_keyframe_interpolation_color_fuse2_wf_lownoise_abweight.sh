...
OUT_DIR=my_results2/r20250304_debug5_colorfuse2_wf_60000_lownoise_skip3_abweight
out_fn=$OUT_DIR/'example.gif'
python z0305_evs_keyframe_interpolation_color_fuse2_6eval_abweight.py \
...
OUT_DIR=my_results2/r20250304_debug5_colorfuse2_wf_60000_lownoise_skip1_abweight
out_fn=$OUT_DIR/'example.gif'
python z0305_evs_keyframe_interpolation_color_fuse2_6eval_abweight.py \
    --frames_dirs="/mnt/workspace/zhangziran/Self_collected_DATASET/train_sd_vfi/test" \
    --pretrained_model_name_or_path=$MODEL_NAME \
...
OUT_DIR=my_results2/r20250304_debug5_colorfuse2_wf_60000_lownoise_skip2_abweight
out_fn=$OUT_DIR/'example.gif'
python z0305_evs_keyframe_interpolation_color_fuse2_6eval_abweight.py \
    --frames_dirs="/mnt/workspace/zhangziran/Self_collected_DATASET/train_sd_vfi/test" \
    --pretrained_model_name_or_path=$MODEL_NAME \
