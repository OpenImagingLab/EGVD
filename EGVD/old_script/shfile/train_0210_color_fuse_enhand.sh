...
accelerate launch --mixed_precision="fp16" evs_train_single_svd3_color_fuse_enhand.py \
  ...
  --num_train_epochs=401 --checkpointing_steps=10000 \
  --validation_epochs=50 \
  --learning_rate=1e-04 --lr_scheduler="constant" --lr_warmup_steps=0 \
  --seed=42 \
  --skip_sampling_rate=-1 \
  --output_dir="ckpt/checkpoints_z0214_wfilter_v8_colorfuse_wof_newfusemodel_woadd_enhand_rerun/svd_reverse_motion_with_attnflip" \
  --cache_dir="ckpt/checkpoints_z0214_wfilter_v8_colorfuse_wof_newfusemodel_woadd_enhand_rerun/svd_reverse_motion_with_attnflip_cache" \
