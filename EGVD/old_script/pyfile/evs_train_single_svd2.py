    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                # print(encoder_hidden_states.shape, evs.shape)
                ...
                # new_condition = conditions_latent + evs_latents + conditions_latent_ref
                ...
                model_pred = unet(noisy_latents_inp, timesteps,
                                encoder_hidden_states=(encoder_hidden_states + encoder_hidden_states_ref)/2.0, 
                                added_time_ids=added_time_ids, 
