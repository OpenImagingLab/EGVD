...
CHECKPOINT_DIR=/mnt/workspace/zhangziran/DiffEVS/svd_keyframe_interpolation-main/ckpt/checkpoints_z0218_newfusemodel_wof/svd_reverse_motion_with_attnflip/checkpoint-120000
MODEL_NAME=/mnt/workspace/zhangziran/DiffEVS/svd_keyframe_interpolation-main/checkpoints/stable-video-diffusion-img2vid


OUT_DIR=my_results2/r20250306_debug5_colorfuse2_wof_120000_skip3
...
OUT_DIR=my_results2/r20250306_debug5_colorfuse2_wof_120000_skip2
out_fn=$OUT_DIR/'example.gif'
python evs_keyframe_interpolation_color_fuse2.py \
    --frames_dirs="/mnt/workspace/zhangziran/Self_collected_DATASET/train_sd_vfi/test" \
    --pretrained_model_name_or_path=$MODEL_NAME \
...
OUT_DIR=my_results2/r20250306_debug5_colorfuse2_wof_120000_skip1
out_fn=$OUT_DIR/'example.gif'
python evs_keyframe_interpolation_color_fuse2.py \
    --frames_dirs="/mnt/workspace/zhangziran/Self_collected_DATASET/train_sd_vfi/test" \
    --pretrained_model_name_or_path=$MODEL_NAME \
