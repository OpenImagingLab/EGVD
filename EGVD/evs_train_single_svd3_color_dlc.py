...
def main():
    ...
    pre_path = "/mnt/workspace/zhangziran/DiffEVS/svd_keyframe_interpolation-main/ckpt/checkpoints_z0213_wfilter_v8_colorfuse_dlc_newfusemodel/svd_reverse_motion_with_attnflip/checkpoint-120000/lef_model_checkpoint.pt"
