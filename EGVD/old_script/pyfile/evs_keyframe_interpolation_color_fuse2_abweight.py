...
from custom_diffusers.pipelines.evs_pipeline_frame_interpolation_with_noise_injection_color_fuse2_abweight import EVSFrameInterpolationWithNoiseInjectionPipeline
        ...
        with open(txt_path, "w") as f:  # 使用'a'模式来附加内容
            ...
            for i, frame in enumerate(frames):
                ...
                lpips_value, ssim_value, psnr_value = calculate_metrics(
                    image1, image2, loss_dict_lpips={'as_loss': False, 'weight': 1.0},
                    loss_dict_ssim={'weight': 1.0}, loss_dict_psnr={'as_loss': False, 'weight': 1.0}
                )
