...
accelerate launch --mixed_precision="fp16" evs_train_single_svd3_color_dlc.py\
  ...
  --output_dir="ckpt/checkpoints_z0218_newfusemodel_wof/svd_reverse_motion_with_attnflip" \
  --cache_dir="ckpt/checkpoints_z0218_newfusemodel_wof/svd_reverse_motion_with_attnflip_cache" \
