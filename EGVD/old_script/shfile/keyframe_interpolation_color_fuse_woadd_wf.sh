...
# CHECKPOINT_DIR=/mnt/workspace/zhangziran/DiffEVS/svd_keyframe_interpolation-main/ckpt/checkpoints_z0214_wfilter_v8_colorfuse_wf_newfusemodel_woadd/svd_reverse_motion_with_attnflip/checkpoint-40000
CHECKPOINT_DIR=/mnt/workspace/zhangziran/DiffEVS/svd_keyframe_interpolation-main/ckpt/checkpoints_z0214_wfilter_v8_colorfuse_wf_newfusemodel_woadd/svd_reverse_motion_with_attnflip/checkpoint-120000
MODEL_NAME=/mnt/workspace/zhangziran/DiffEVS/svd_keyframe_interpolation-main/checkpoints/stable-video-diffusion-img2vid



OUT_DIR=my_results/r20250216_debug5_colorfuse_newmodel_wf_newfusemodel_woadd_120000_skip3
out_fn=$OUT_DIR/'example.gif'
python evs_keyframe_interpolation_color_fuse_woadd.py \
...
OUT_DIR=my_results/r20250216_debug5_colorfuse_newmodel_wf_newfusemodel_woadd_120000_skip2
out_fn=$OUT_DIR/'example.gif'
python evs_keyframe_interpolation_color_fuse_woadd.py \
    --frames_dirs="/mnt/workspace/zhangziran/Self_collected_DATASET/train_sd_vfi/test" \
    --pretrained_model_name_or_path=$MODEL_NAME \
...
OUT_DIR=my_results/r20250215_debug5_colorfuse_newmodel_wf_newfusemodel_woadd_120000_skip1
out_fn=$OUT_DIR/'example.gif'
python evs_keyframe_interpolation_color_fuse_woadd.py \
    --frames_dirs="/mnt/workspace/zhangziran/Self_collected_DATASET/train_sd_vfi/test" \
    --pretrained_model_name_or_path=$MODEL_NAME \
