...
from custom_diffusers.pipelines.evs_pipeline_frame_interpolation_with_noise_injection_old0208 import EVSFrameInterpolationWithNoiseInjectionPipeline
...
from dataset.stable_video_dataset_old import StableVideoDataset,StableVideoTestDataset
...
def main(args):
    ...
    pipe.ori_unet.config.num_frames =  finetuned_unet.config.num_frames
    ...
    dataset = StableVideoTestDataset(args,args.frames_dirs,num_frames=finetuned_unet.config.num_frames)
