...
accelerate launch --mixed_precision="fp16" evs_train_single_svd.py \
  ...
  --num_train_epochs=1000 --checkpointing_steps=100 \
  --validation_epochs=50 \
  --learning_rate=1e-04 --lr_scheduler="constant" --lr_warmup_steps=0 \
  --seed=42 \
  --double_sampling_rate \
  --output_dir="ckpt/checkpoints_wnorm_wofilter_v6/svd_reverse_motion_with_attnflip" \
  --cache_dir="ckpt/checkpoints_wnorm_wofilter_v6/svd_reverse_motion_with_attnflip_cache" \
